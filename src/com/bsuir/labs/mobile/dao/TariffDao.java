...
public class TariffDao implements Dao {
    ...
    @Override
    public void subscribe(Tariff tariffToSubscribe) throws NoUserException, AlreadyHasTariffException {
        if (this.user != null) {
            if(this.user.getTariff() == null) {
                ...
                throw new AlreadyHasTariffException("You already has tariff");
            }
        } else {
